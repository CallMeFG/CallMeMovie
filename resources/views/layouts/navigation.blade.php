<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <img src="{{ asset('images/logo-letter-c.png') }}" alt="MovieLog Logo" class="block h-9 w-auto">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('movies.search')" :active="request()->routeIs('movies.search')">
                        {{ __('Cari Film') }}
                    </x-nav-link>
                    {{-- Hanya tampilkan My Watchlist jika user sudah login --}}
                    @auth
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('movies.search')" :active="request()->routeIs('movies.search')">
                {{ __('Cari Film') }}
            </x-responsive-nav-link>
            @auth
